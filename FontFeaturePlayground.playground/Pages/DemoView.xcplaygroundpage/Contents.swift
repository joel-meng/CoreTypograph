...
private func typographyLable(withText text: String, font: UIFont) -> UILabel {
    ...
    resultLabel.preferredMaxLayoutWidth = 320
    resultLabel.sizeToFit()
...
let demoView1 = demoView(text: "ffg\nlkajsdflaskdfj\n",
                         font1: UIFont.systemFont(ofSize: 20),
                         font2: UIFont.systemFont(ofSize: 20),
                         title: "Ligature")
demoView1.frame.height
PlaygroundPage.current.liveView = demoView1
